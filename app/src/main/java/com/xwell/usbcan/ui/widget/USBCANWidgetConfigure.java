...
public class USBCANWidgetConfigure extends Activity {
	private static final String TAG = "USBCANWidgetConfigure";
	...
	public void onCreate(Bundle icicle) {
		...
		final RadioButton def = (RadioButton)findViewById(R.id.usbcan);
		def.setChecked(true);
		...
		add.setOnClickListener(new View.OnClickListener() {
				...
				public void onClick(View v) {
					final Context context = USBCANWidgetConfigure.this;
					...
					USBCANWidgetProvider.updateWidget(context, AppWidgetManager.getInstance(context),
													  appWidgetId, streamid,-1,-1);
